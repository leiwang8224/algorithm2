...
public class LongestValidParen {
    ...
    /**
     * Brute force method
     * Time complexity : O(n^3)O(n3). Generating every possible substring from a string of length nn requires
     * O(n^2)O(n2). Checking validity of a string of length nn requires O(n)O(n).
